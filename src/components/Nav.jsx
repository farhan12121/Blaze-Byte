    ...
    return (
        <div className="navbar bg-base-100 shadow-lg px-8 fixed z-10">
            <div className="flex-1">
                <NavLink to={'./'} className="btn btn-ghost text-2xl text-secondary gap-0 normal-case">Byte<span className="text-primary">Blaze</span></NavLink>
            </div>
            <div className="flex-none">
                <ul className="menu menu-horizontal px-1 gap-5 font-bold mr-5">
